...
def predict():
    ...
    redirect(url_for('details'))
    return render_template("details.html", active_page='details', title="Details", predict=predicted, msg='Hi, '+session['name'], origin_airports=origin_airports, dest_airports=destination_airports)
